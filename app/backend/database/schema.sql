...
CREATE TABLE IF NOT EXISTS knowledge_relations (
  ...
  relation_layer TEXT NOT NULL DEFAULT 'semantic',
  relation_strength TEXT NOT NULL DEFAULT 'medium',
  display_default INTEGER NOT NULL DEFAULT 1,
  score REAL NOT NULL,
  reason TEXT,
  created_at TEXT NOT NULL,
